...
fn commit_with_optional_tag(
    ...
    let sig = Signature::now("github-actions[bot]", "github-actions[bot]@users.noreply.github.com")
    ...
    index
        .add_all(["Cargo.toml"].iter(), IndexAddOption::DEFAULT, None)
...
mod tests {
    ...
    fn test_commit_and_tag() {
        ...
        commit_and_tag(dir.path(), "chore: bump version to 1.0.1-dev0", "v1.0.1-dev0").unwrap();
